...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="${pageContext.request.contextPath}/user/userInfo">用户信息</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="${pageContext.request.contextPath}/user/personalInfo">个人信息</a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="container mt-5">
  <div class="user-info">
    ...
    <c:if test="${not empty requestScope.user}">
      ...
      <a href="${pageContext.request.contextPath}/user/personalInfo" class="btn btn-warning">编辑信息</a>
    </c:if>
